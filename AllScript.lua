...
elseif PlaceId == 4520749081 or PlaceId == 6381829480 or PlaceId == 5931540094 then
	loadstring(game:HttpGet(("https://raw.githubusercontent.com/aofpooere/Attack-King/main/KingLegacy.lua"), true))()
...
elseif PlaceId == 2753915549 or PlaceId == 4442272183 or PlaceId == 7449423635 then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/aofpooere/Attack-X-HubV1/main/AllScript.lua"))()
...
elseif PlaceId == 3102144307 then
	loadstring(game:HttpGet(("https://raw.githubusercontent.com/aofpooere/xScript-Free/main/AnimeClicker.lua"), true))()
else
	game.Players.LocalPlayer:kick("ฝากโปรโมทสคริปด้วย :)")
    wait(1)
    game:Shutdown()
end
